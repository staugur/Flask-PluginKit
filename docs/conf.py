...
htmlhelp_basename = 'Flask-PluginKitdoc'
...
latex_documents = [
    (master_doc, 'Flask-PluginKit.tex', u'Flask-PluginKit Documentation',
     u'staugur', 'manual'),
]
...
man_pages = [
    (master_doc, 'flask-pluginkit', u'Flask-PluginKit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Flask-PluginKit', u'Flask-PluginKit Documentation',
     author, 'Flask-PluginKit', 'One line description of project.',
     'Miscellaneous'),
]
